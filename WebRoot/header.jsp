    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Notice/frontlist">公告信息</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">公共留言</a></li>
                <li><a href="<%=basePath %>Pet/frontlist">宠物</a></li>
                <li><a href="<%=basePath %>Food/frontlist">宠物粮食</a></li>
                <li><a href="<%=basePath %>FoodOrder/frontlist">宠粮订单</a></li>
                <li><a href="<%=basePath %>Adopt/frontlist">领养</a></li>
